#!/usr/bin/env python3
"""
Run migration to add file_path field to us_table
...
from pyarchinit_mini.database.migration_scripts.add_file_path import upgrade, downgrade
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python run_file_path_migration.py [upgrade|downgrade]")
        sys.exit(1)
