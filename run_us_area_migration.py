#!/usr/bin/env python3
"""
Run migration to change us and area columns to text types
...
from pyarchinit_mini.database.migration_scripts.change_us_area_to_text_simple import upgrade, downgrade
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python run_us_area_migration.py [upgrade|downgrade]")
        sys.exit(1)
