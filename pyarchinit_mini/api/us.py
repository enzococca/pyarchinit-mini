...
from .dependencies import get_us_service, get_database_connection
...
async def update_us(
    ...
    try:
        ...
        if if_match is not None:
            ...
            conflict = cm.check_version_conflict('us_table', us_id, int(if_match))
            if conflict:
        ...
        if if_match is not None:
            cm.increment_version('us_table', us_id, "api_user")
